...
from points_discounts import handle_points_discounts_callback
...
async def webhook_handler(request: Request) -> Response:
    try:
        ...
        if callback_query:
            ...
            if callback_data.startswith(("menu:points", "menu:discounts", "menu:giveaways", "discount_category:", "profile:", "services:", "book:", "get_discount:", "giveaway_points:", "giveaway_book:")):
                await handle_points_discounts_callback(callback_query)
            else:
